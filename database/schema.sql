...
('cat-1', 'BG', 'Bàn ghế', 'Bàn và ghế học tập, sinh hoạt', 'Bộ', 10.00, 24),
('cat-2', 'GT', 'Giường tủ', 'Giường ngủ và tủ đựng đồ', 'Bộ', 8.00, 36),
('cat-3', 'ĐH', 'Điều hòa', 'Máy điều hòa nhiệt độ', 'Cái', 15.00, 24),
('cat-4', 'QT', 'Quạt', 'Quạt trần, quạt đứng', 'Cái', 12.00, 12),
('cat-5', 'BN', 'Bình nóng lạnh', 'Bình đun nước nóng', 'Cái', 10.00, 24),
('cat-6', 'DD', 'Đồ điện', 'Thiết bị điện khác (đèn, ổ cắm...)', 'Cái', 20.00, 12);
